...
//What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  ...
  // I had trouble with two tests. The first was for adding the spouse property to adam with the value of terah. I didn't realize until this point that I had actually just created a new object and replaced the values of terah. I fixed this by using proper notation to add properties instead of just making a new object.
  // The second one that I had trouble with was adding the children. I decided to try simply nesting objects and properties within each other after a little trial and error. This worked wonderfully!

// How difficult was it to add and delete properties outside of the object itself?

  // Deleting seemed very easy. Adding took a little more research. Just adding regular properties was easy, but adding objects took a little bit of thinking.

// What did you learn about manipulating objects in this challenge?
//
  // I learned a lot about manipulating objects with javascript. I honed my skills on creating objects and properties. I learned new skills on adding properties to objects.
// __________________________________________
